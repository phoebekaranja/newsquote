...
export class QuoteComponent implements OnInit {
    ...
    quotes = [
        ...
        new Quote(3, 'A man who dares to waste one hour of time has not discovered the value of life', 'phoebe','karanja',new Date(),0,0,0,false),
        new Quote(4, 'If life were predictable it would cease to be life, and be without flavor', 'phoebe','karanja',new Date(),0,0,0,false),
        new Quote(5, 'All life is an experiment. The more experiments you make the better', 'phoebe','karanja',new Date(),0,0,0,false)
